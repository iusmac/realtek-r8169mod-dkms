...
if [ "$module" = "" ]; then
	...
	if test -e $TARGET_PATH/r8169mod.ko ; then
		echo "Backup r8169mod.ko"
		if test -e $TARGET_PATH/r8169mod.bak ; then
			i=0
			while test -e $TARGET_PATH/r8169mod.bak$i
			do
				i=$(($i+1))
			done
			echo "rename r8169mod.ko to r8169mod.bak$i"
			mv $TARGET_PATH/r8169mod.ko $TARGET_PATH/r8169mod.bak$i
		else
			echo "rename r8169mod.ko to r8169mod.bak"
			mv $TARGET_PATH/r8169mod.ko $TARGET_PATH/r8169mod.bak
		fi
	fi
fi
